...
const flowers: Flower[] = [
  { id: 1, name: "ORCHID", meaning: "Beauty", birthMonth: "October", image: "/flowers/0-orchid.png", size: "medium" },
  { id: 2, name: "TULIP", meaning: "Perfect love", birthMonth: "April", image: "/flowers/1-tulip.png", size: "medium" },
  { id: 3, name: "DAHLIA", meaning: "Elegance", birthMonth: "August", image: "/flowers/2-dahlia.png", size: "small" },
  { id: 4, name: "ANEMONE", meaning: "Anticipation", birthMonth: "September", image: "/flowers/3-anemone.png", size: "medium" },
  { id: 5, name: "CARNATION", meaning: "Fascination", birthMonth: "January", image: "/flowers/4-carnation.png", size: "large" },
  { id: 6, name: "ZINNIA", meaning: "Lasting Affection", birthMonth: "July", image: "/flowers/5-zinnia.png", size: "medium" },
  { id: 7, name: "RANUNCULUS", meaning: "Radiant Charm", birthMonth: "March", image: "/flowers/6-ranunculus.png", size: "medium" },
  { id: 8, name: "SUNFLOWER", meaning: "Adoration", birthMonth: "August", image: "/flowers/7-sunflower.png", size: "large" },
  { id: 9, name: "LILY", meaning: "Purity", birthMonth: "May", image: "/flowers/8-lily.png", size: "large" },
  { id: 10, name: "DAISY", meaning: "Innocence", birthMonth: "April", image: "/flowers/9-daisy.png", size: "small" },
  { id: 11, name: "PEONY", meaning: "Romance", birthMonth: "May", image: "/flowers/10-peony.png", size: "medium" },
  { id: 12, name: "ROSE", meaning: "Love and passion", birthMonth: "June", image: "/flowers/11-rose.png", size: "medium" },
]
      ...
      <div className="flex flex-wrap justify-center gap-4 mb-8 items-center min-h-[200px]">
        {flowers.map((flower) => (
          ...
          >
            <div
              className={`${
                flower.size === "small" ? "w-32 h-32" : 
                flower.size === "large" ? "w-48 h-48" : 
                "w-40 h-40"
